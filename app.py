        ...
        const surroundingGuides = {
            ...
            toyosu: {
                ...
                spots: [
                    ...
                    { name: '茂助玉子燒（茂助だんご，Mosuke）', desc: '市場內百年老店，甜甜的日式煎蛋捲小孩絕對愛吃。', tag: '市場玉子燒', icon: '🍳', mapQuery: '豊洲市場 玉子焼' },
                    ...
                    { name: '麵屋 黑琥（麺や 黒琥，Kuroko）', desc: 'LaLaport 內。豚骨與醬油拉麵，方便快速。', tag: '日式拉麵', icon: '🍜', mapQuery: '麺や 黒琥 ららぽーと豊洲' },
            ...
            skytree: {
                ...
                spots: [
                    ...
                    { name: '星之卡比咖啡廳（KIRBY CAFÉ / カービィカフェ）', desc: '4F。超可愛星之卡比主題餐點與專賣店。', tag: '主題餐廳', icon: '⭐', mapQuery: 'KIRBY CAFE TOKYO' },
            ...
            karuizawa: {
                ...
                spots: [
                    ...
                    { name: '史努比村（SNOOPY Village / スヌーピービレッジ）', desc: '舊輕井澤。超可愛的史努比茶屋與伴手禮。', tag: '卡通茶屋', icon: '🐶', mapQuery: 'SNOOPY Village 軽井沢' },
            ...
            shibuya: {
                ...
                spots: [
                    ...
                    { name: '阿夫利（AFURI，Afuri）', desc: 'PARCO B1。帶有柚子清香的清爽拉麵，不油膩。', tag: '柚子拉麵', icon: '🍜', mapQuery: 'AFURI 渋谷パルコ' },
                    { name: '燒肉 牛角 渋谷店（牛角，Gyukaku）', desc: '平價連鎖燒肉，菜單豐富無壓力，適合親子。', tag: '平價燒肉', icon: '🥩', mapQuery: '牛角 渋谷店' },
