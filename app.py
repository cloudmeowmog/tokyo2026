    ...
    <script type="text/babel">
        ...
        const surroundingGuides = {
            ...
            toyosu: {
                ...
                spots: [
                    ...
                    { name: '100本のスプーン (LaLaport 內)', desc: '極具人氣的質感親子餐廳！小孩可點跟大人一模一樣的「半份」餐點。', tag: '親子餐廳', icon: '🍽️', mapQuery: '100 Spoons Toyosu' },
                    { name: '築地食堂 源ちゃん (LaLaport 內)', desc: '提供美味的生魚片海鮮丼，以及小孩愛吃的炸雞、炸蝦熟食定食。', tag: '和食', icon: '🍱', mapQuery: 'Tsukiji Shokudo Genchan LaLaport Toyosu' },
                    { name: '茂助玉子燒 (豐洲市場)', desc: '豐洲市場百年老店，甜甜的日式煎蛋捲小孩最愛。', tag: '和食', icon: '🍳', mapQuery: 'Mosuke Tamagoyaki Toyosu Market' }
                ]
            },
            odaiba: {
                name: '台場周邊',
            ...
            asakusa: {
                name: '淺草周邊',
                spots: [
                    { name: '藏壽司 淺草ROX旗艦店', desc: '全球最大的藏壽司之一！有獨家祭典裝潢、射擊遊戲與巨大扭蛋機。', tag: '和食遊樂', icon: '🍣', mapQuery: 'Kura Sushi Asakusa ROX' },
        ...
        const itinerary = [
             ...
             { day: 2, date: "4/18 (六)", title: "台場鋼彈 & 豐洲", events: [ 
                 ...
                 { time: "19:30", title: "豐洲 LaLaport", desc: "晚餐", icon: "🍽️", location: "Urban Dock LaLaport Toyosu", transport: { route: "新豐洲 → 豐洲", line: "海鷗號/步行", time: "10分" }, tips: "推薦【100本のスプーン】(質感親子餐廳，可點半份套餐)；或【築地食堂 源ちゃん】(美味海鮮丼與熟食定食)。" }, 
             ...
             { day: 5, date: "4/21 (二)", title: "築地・渋谷・新宿", events: [ 
                 ...
                 { time: "13:30", title: "澀谷午餐", desc: "魚米/美食街", icon: "🍽️", location: "Shibuya Scramble Square", transport: { route: "PARCO → 餐廳", line: "步行", time: "10分" }, tips: "推薦【魚米】新幹線送餐小孩超愛；或直接到展望台樓下的【Scramble Square】吃大阪燒。" }, 
        ...
        const attractionInfos = [
            ...
            { id: "toyosu_lalaport", name: "豐洲 LaLaport 親子晚餐", icon: "🍽️", tag: "美食", desc: "推薦：【100本のスプーン (100 Spoons)】全日本超人氣的質感親子餐廳，小孩可以點跟大人一模一樣的「半份」餐點；喜歡和食可選【築地食堂 源ちゃん】，有海鮮丼與熟食炸物定食。", tips: "吃飽後可以逛 3 樓，有扭蛋機與玩具專賣店讓小朋友放電！" },
        ...
        const MapView = () => {
            ...
            const [surrArea, setSurrArea] = useState('ueno'); // 預設上野
            const imgRef = useRef(null);
            const tripImgRef = useRef(null); // 新增：全覽地圖專用的 ref
